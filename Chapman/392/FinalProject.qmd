...
### Part #5 (Individual)
(**38 points**;  PDF Report + Code File) **Perform the planned analyses for your 3 questions** , **make the graphs in a python notebook**, and write a **technical report using Quarto or Google Docs Template**. For each of your 3 questions make sure you have:
...
(**38 points**;  PDF Report + Code File) **Perform the planned analyses for your questions** , **make the graphs in a python notebook**, and write a **technical report using Quarto or Google Docs Template**. For each of your questions (2 per group member) make sure you have:
...
- (🧑‍🤝‍🧑 *Together*) For Part II, #5 You should work on it together. Again, you need to answer 2 questions **per member** (so a group of 2 would need to answer 4 questions, a group of 3 would need to answer 6). You must ALSO submit a joined statement (in your readme) describing what each member did. 
